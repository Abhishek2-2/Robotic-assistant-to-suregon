...
#p_pick = np.array([0.167729, 0.143286, 0.057])
#p_pick = np.array([0.1677, 0.1432, 0.087])



listener = tf.TransformListener()

listener.waitForTransform("/world", "/logical_camera_2_gear_part_frame", rospy.Time(), rospy.Duration(10.0))
(trans, rot) = listener.lookupTransform('world', 'logical_camera_2_gear_part_frame', rospy.Time())

p_pick = np.array([trans[0],trans[1],0.087])
